...
namespace BankAccount.Data.Migrations
{
    ...
    [Migration("20201012163333_AddedBank")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankAccount.Domain.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BankAccount.Domain.Account", b =>
                {
                    b.HasOne("BankAccount.Domain.Address", "Address")
                        .WithOne("Account")
                        .HasForeignKey("BankAccount.Domain.Account", "Address_Id")
